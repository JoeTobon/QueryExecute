...
public class QueryUI 
{
	public static JFrame buildUI()
	{
        ...
        //queryFrame.getIconImage(URL(/Users/sudo/Desktop/Screen%20Shot%202019-02-28%20at%2010.26.56%20AM.png));
        ...
        JLabel titleLabel = new JLabel("STAGGS DATABASE MANAGEMENT GUI");
        titleBar.add(titleLabel);
        queryFrame.add(titleBar);
        
        
        JPanel textFieldPane = new JPanel();
        //textFieldPane.getParent().getSize();
        textFieldPane.setPreferredSize(new Dimension(600,75));
        
        //TextField Definition
        JTextField textField = new JTextField();
        //textField.getParent().getSize();
